    ...
    <div className="h-full flex flex-col bg-white">
      <div className="flex-1 pb-20 overflow-auto">
        ...
        <div className="h-64 bg-[#E6E8E6] flex items-center justify-center relative">
          ...
          <div className="absolute top-4 left-4 bg-[#F15025] text-white px-3 py-1 rounded-lg text-xs">
            0.8 mi
          </div>
          <div className="absolute top-12 right-8 bg-[#F15025] text-white px-3 py-1 rounded-lg text-xs">
            1.2 mi
          </div>
          <div className="absolute bottom-8 left-12 bg-[#F15025] text-white px-3 py-1 rounded-lg text-xs">
            2.1 mi
          </div>
        </div>
